...
namespace UVS
{
    ...
    public sealed class SpoutSender : MonoBehaviour
    {
        ...
        internal enum SpoutGraphicEvent { Update = 0, Dispose = 1 }
        ...
        private void CreateTextureGetterAndRegister()
        {
            ComponentManager.AddManagedComponent<GetTextureByOnRenderImage>(gameObject, (textureFetcher) =>
            {
                ...
                {
                    Debug.LogError("SPOUT SENDER: unexpected missing textureFetcher");
                }
        ...
        void OnTextureResize()
        {
            ...
            GraphicEventManager.IssuePluginEvent((int)SpoutGraphicEvent.Dispose, spoutSender);
        ...
        private void Update()
        {
            ...
            {
                GraphicEventManager.IssuePluginEvent((int)SpoutGraphicEvent.Update, spoutSender);
            }
        }
        ...
        private void LazyInitializeResources()
        {
            ...
            {
                blitMaterial = new Material(Shader.Find("UVS/Hidden/SpoutBlit"));
