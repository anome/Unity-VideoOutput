...
@implementation SyphonServerRendererMetalWithExtras
{
...
- (nonnull instancetype)initWithDevice:(id<MTLDevice>)device colorPixelFormat:(MTLPixelFormat)colorPixelFormat msaaSampleCount:(NSInteger)sampleCount
{
    ...
    if( self )
    {
        ...
        _device = device;
        _sampleCount = [SyphonServerRendererMetalWithExtras safeMsaaSampleCountForDevice:device unsafeSampleCount:sampleCount verbose:NO];
