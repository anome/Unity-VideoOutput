...
@interface SyphonMetalServerWithExtras : SyphonServerBase

- (id)initWithName:(NSString*)name device:(id<MTLDevice>)device options:(NSDictionary *)options srgb:(BOOL)srgb;
